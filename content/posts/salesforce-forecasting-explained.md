...
Forecasts are arguable the most intimidating feature to a newbie in sales cloud as the concept is very foreign. Personally, I've found it's because it throws a bunch of new terminology at you whilst expecting you to understand how it works. I'll be breaking terms down as they come up.
...
- Reach out to reps and managers can see changes
- Change category names
- Breadcrumb trail of reports (Who reports to who, reports to who)
- opportunity amounts as the source of truth

Forecasts are composed of opportunities at different stages. These stages also exist within forecast categories. For instance, an 8-step opportunity path can be condensed into 5 forecast categories.
...
**Forecast Adjustment (W Notes)**
 ...
 ![image-20220704190809013](/Users/isowunmi/Library/Application Support/typora-user-images/image-20220704190809013.png)

When a sales leader or manger alters the forecast they can also lead a note to explain what’s going on.
